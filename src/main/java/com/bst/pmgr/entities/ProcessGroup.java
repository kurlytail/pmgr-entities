...
import com.bst.pmgr.entities.audit.ProcessGroupAudit;
import com.fasterxml.jackson.annotation.JsonIdentityInfo;
import com.fasterxml.jackson.annotation.ObjectIdGenerators;

@EntityListeners(ProcessGroupAudit.class)
@Entity
...
public class ProcessGroup {
	...
	public boolean equals(final Object obj) {
		...
		final ProcessGroup other = (ProcessGroup) obj;
		if (this.id == null) {
			if (other.id != null) {
				return false;
			}
	...
	public String toString() {
		return "ProcessGroup [id=" + this.id + ", name=" + this.name + ", metaName=" + this.metaName + ", work="
				+ this.work + "]";
	}
